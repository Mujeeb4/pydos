"""
Phase 6: Logging Module
Real-Time DDoS Detection System

This module provides comprehensive logging functionality for the DDoS detection system.
Features:
- File-based logging with rotation
- Different log levels (DEBUG, INFO, WARNING, ERROR, CRITICAL)
- Structured log format with timestamps
- Separate logs for events, attacks, and system operations
"""
